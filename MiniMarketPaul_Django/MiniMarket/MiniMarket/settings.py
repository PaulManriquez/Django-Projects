...
SECRET_KEY = 'django-insecure-jxbgftobp-ebv_27sm($oa@lltpcmsa%+ghgpb1z-pyd65l!o1'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'CartApp.context_processor.Total_Pay_Cart',
            ],
        },
    },
]
...
MEDIA_URL = '/media/' #<-- Public url how to acces to the media 
MEDIA_ROOT = os.path.join(BASE_DIR,'media') #<-- Tell to Django where to search the Dir for media files 
